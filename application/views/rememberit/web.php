...
<?php 
if(getPost () == 'edit') {
	$accObj = Models\Website::find_by_id(getId());
...
<table style="float:left;">
	...
	<tr>
		<td><label for="weblink">Web Link:</label></td>
		<td><input type="text" id="weblink" name="weblink" class="input" value="<?php 
		echo $account->weblink;
		if(!$_SESSION['success']) echo $_POST['weblink']; 
		?>" /></td>
	</tr>
	<tr>
		<td></td>
...
<tr>
<td>
<h1 style="color:#b3720e;"><img src=<?php echo IMAGES_PATH . "/icons/web.png"; ?> align="top" />Websites</h1>
<p>Here you can add, edit or delete your website accounts. 
For instance if you have a login account for facebook all you need is to enter the weblink for facebook, 
...
<p>Web Link:http://www.yourlink.com</p>
</td>
</tr>
</table>
</form>
<div style="float:left; width:950px;"><?php echo Models\Website::renderForControl(); ?></div>
</div>
